...
class EntryFormState extends State<EntryForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: contact == null ? Text('Tambahkan Kontak') : Text('Edit Kontak'),
                  ...
                  Expanded(
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if (contact == null) {
                          // tambah data
                          contact = Contact(nameController.text, phoneController.text, emailController.text, alamatController.text);
                        } else {
                          // ubah data
